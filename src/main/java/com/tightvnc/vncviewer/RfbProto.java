...
class RfbProto {
  ...
  void writeClientInit() throws IOException {
    if (viewer != null && viewer.options.shareDesktop) {
      os.write(1);
    } else {
      os.write(0);
    }
  ...
  void writePointerEvent(MouseEvent evt) throws IOException {
    ...
    int mask2 = 2;
    int mask3 = 4;
    if (viewer != null && viewer.options.reverseMouseButtons2And3) {
      mask2 = 4;
      mask3 = 2;
    }
